...
public class Menu extends JPanel {
    ...
    private final String menuItems[][] = {
        ...
        {"Vouchers & Discounts"},
        {"~MANAGEMENT~"},
        {"Inventory", "Stock Available", "Add New Product", "Add New Product Category", "Add/Update Stock", "Low Stock", "Expired Stock"},
        {"Staff Management"},
        {"Shop Expenses"},
        {"Users", "Manage User", "Add User Role"},
        {"Balance View"},
        {"~SUPPLIERS~"},
        {"Supplier Record", "Suppliers", "Ledger"},
        {"Orders Management", "Make an Order", "Status Management", "Payment Management","Supplier Payment History"},
        {"Return TO Supplier"},
        {"~REPORTS~"}, 
        {"Reports","Available Stock", "Low Stock", "Sales", "Balance & Profits", "Total Stock Added", "Total Products Sold", "All Expenses Report", "Total Products Returned", "Returned To Supplier","Supplier Payment History"},
        {"~OTHER~"}, 
        {"Back Up"},
        {"Logout"},
        {"About"},
    ...
    private final String headerName = "POS";
