...
public class AddNewStock extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jCheckBox1.setText("Barcode Exists");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if((jComboBox3.getSelectedItem()=="")||("".equals(jTextField4.getText()))||("".equals(jTextField5.getText()))||("".equals(jTextField9.getText()))||(jDateChooser1.getDate()==null)){
        
                                      Notifications.getInstance().show(Notifications.Type.ERROR, Notifications.Location.TOP_CENTER, "Please Enter the Required Field"); 
      ...
      if(aa>=ab){
           ...
           boolean ys = false;
            while(rs1.next()){
             ...
             PreparedStatement ps22=connection.prepareStatement("INSERT INTO productId (insert) VALUES (?)");
long pid=0;
             PreparedStatement ps2=connection.prepareStatement("INSERT INTO Products (Product_Name, Product_Category, Product_Id) VALUES (?,?,?)");
            if(ys==false){
               if(jCheckBox1.isSelected()){
                   pid=Long.parseLong(jTextField6.getText());
               }else{
                 ps22.setString(1, "idi");
                  ps22.executeUpdate();
                  
                   String sql2="SELECT ID FROM productId ORDER BY ID DESC LIMIT 1";
           ...
           if(exists1==true){
                              Notifications.getInstance().show(Notifications.Type.ERROR, Notifications.Location.TOP_CENTER, "Enter a new product. This Product Already Exists! \n If you want to add more QUANTITY goto Update Product. "); 
