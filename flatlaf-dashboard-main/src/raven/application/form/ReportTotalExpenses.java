...
private String discription;
   ...
   private static PrintService findPrintService(String printerName) {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "All", "Pays", "Utility Bill", "Rent", "Entertainment", "Other Expenses" }));
...
DefaultTableModel tbm=(DefaultTableModel)jTable1.getModel();
        ...
        while(rs15.next()){
                        if((((rs15.getDate(5).toLocalDate()).isAfter( date1))||((rs15.getDate(5).toLocalDate()).isEqual(date1))) && ((rs15.getDate(5).toLocalDate().isBefore(date))||(rs15.getDate(5).toLocalDate().isEqual(date)))){
...
Statement stt=connection.createStatement();
ResultSet rs15=stt.executeQuery("SELECT E_Invoice_Id, E_Name, Benificiary_Name, TotalBill, Date_Time, Discription FROM Expenses WHERE E_Name='"+"Pays"+"'");
...
}else if(jComboBox1.getSelectedItem().equals("Utility Bill")){
filter="Utility Bill , Date  From : "+date1+" To : "+date;

//Now trying to get the record from the sales table;

Statement stt=connection.createStatement();
ResultSet rs15=stt.executeQuery("SELECT E_Invoice_Id, E_Name, Benificiary_Name, TotalBill, Date_Time, Discription FROM Expenses WHERE E_Name = '"+"Utility Bill"+"'");
...
}else if(jComboBox1.getSelectedItem().equals("Rent")){
filter="Rent , Date  From : "+date1+" To : "+date;

//Now trying to get the record from the sales table;

Statement stt=connection.createStatement();
ResultSet rs15=stt.executeQuery("SELECT E_Invoice_Id, E_Name, Benificiary_Name, TotalBill, Date_Time, Discription FROM Expenses WHERE E_Name = '"+"Rent"+"'");
...
}else if(jComboBox1.getSelectedItem().equals("Entertainment")){
filter="Entertainment , Date  From : "+date1+" To : "+date;

//Now trying to get the record from the sales table;

Statement stt=connection.createStatement();
ResultSet rs15=stt.executeQuery("SELECT E_Invoice_Id, E_Name, Benificiary_Name, TotalBill, Date_Time, Discription FROM Expenses WHERE E_Name = '"+"Entertainment"+"'");
...
}else if(jComboBox1.getSelectedItem().equals("Other Expenses")){
filter="Other Expenses , Date  From : "+date1+" To : "+date;

//Now trying to get the record from the sales table;

Statement stt=connection.createStatement();
ResultSet rs15=stt.executeQuery("SELECT E_Invoice_Id, E_Name, Benificiary_Name, TotalBill, Date_Time, Discription FROM Expenses WHERE E_Name = '"+"Other Expenses"+"'");
